    ...
    dashboardBody(tabItems(
        ...
        tabItem("complexplot",
                fluidRow(
                    ...
                    box(
                        title = "The parameter for complex heatmap",
                        solidHeader = T,
                        status = "info",
                        collapsible = T,
                        collapsed = F,
                        ...
                        fluidRow(
                            box(
                                title = "Expression To Color Option",
                                solidHeader = T,
                                status = "info",
                                width = 12,
                                ...
                                fluidRow(
                                    ...
                                    column(
                                        ...
                                        selectInput(
                                            "lowcol",
                                            label = "Low color",
                                            choices = c("green", "blue", "purple", "red",
                                                        "orange", "yellow", "white"),
                                            selected = "green"
                                        )
                                    ),
                            ...
                            box(
                                ...
                                fluidRow(column(
                                    ...
                                    selectInput(
                                        "distance",
                                        label = "Select distance to cluster",
                                        c(
                                            "euclidean",
                                            "maximum",
                                            "manhattan",
                                ...
                                column(
                                    ...
                                    selectInput(
                                        "algorithm",
                                        label = "Select algorithm to cluster",
